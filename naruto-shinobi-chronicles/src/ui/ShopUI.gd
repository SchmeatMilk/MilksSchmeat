...
func _init() -> void:
	...
	_ryo_label.position = Vector2(0, -12)
	_ryo_label.add_theme_font_size_override("font_size", FONT_SIZE)
	_ryo_label.add_theme_color_override("font_color", Color("#ffe08a"))
	_ryo_label.add_theme_color_override("font_outline_color", Color("#26304a"))
	_ryo_label.add_theme_constant_override("outline_size", 3)
