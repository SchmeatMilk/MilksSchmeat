...
A GBA FireRed-style **turn-based tactical RPG / ninja collector** demake, built in
**Godot 4.3** with self-imposed Game Boy Advance constraints (240×160 viewport,
integer scaling, palette-block placeholder art, 32KB-budget binary saves).

This is a non-commercial fan project. It ships **no Nintendo/Shueisha assets** —
all art is procedural placeholder color blocks, all data is original JSON.
...
Not yet: real pixel art & tracker music (placeholder blocks + synthesized blips),
Chunin Exam arena, Acts 4–6, Android signing config.
